...
**Attribution statement:** *The following teaching materials have been iteratively developed by current and former instructors, including: Tom Robinson and Ryan Hübert. This file is based on resources created by Pablo Barberá and Friedrich Geiecke. You can find their comprehensive examples of **ggplot** in the `03a-ggplot2-basics.Rmd` and `03b-scales-axes-legends.Rmd` files.*
