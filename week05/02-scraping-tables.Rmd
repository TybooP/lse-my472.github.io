...
When there are multiple tables on the website, scraping them beco mes a bit more complicated. Let's work through an exemplary scenario: Scraping a table from Wikipedia with a list of the most populated cities in the United States.
